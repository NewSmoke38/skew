...
export default function SignUp() {
  return (
    <form className="w-full max-w-md bg-white border-4 border-black rounded-2xl shadow-[6px_6px_0_0_rgba(0,0,0,1)] p-8 flex flex-col gap-6">
      <h2 className="text-3xl font-black text-black mb-2 text-center">Sign Up</h2>
      <input
        type="text"
        placeholder="Name"
      ...
      <div className="text-center text-black font-semibold">
        ...
        <button type="button" className="underline font-bold hover:text-blue-600">Login</button>
      </div>
    </form>
  );
} 